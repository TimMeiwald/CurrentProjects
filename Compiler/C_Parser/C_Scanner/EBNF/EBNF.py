...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 16 08:46:57 2021
...
class EBNFParser():
            ...
            if(Token[0] == j):
                for i in Token[1:-2]:
                    if(self.Character(i) == 0):
                        ...
                        return -1
                if(Token[-1] == j):
                    #print("Terminal Passed with Token {}".format(Token))
                    return 0
                else: 
    ...
    def Lhs(self,Token):
        if(self.Identifier(Token) == 0):
            #print("Lhs passed with Token {}".format(Token))
            return 0
        else:
    ...
    def Rhs(self,TokenList):
        ...
        for j in TokenList:
            if(j in Seps):
                ...
                if(self.Rhs(Lefthandside_of_Rhs) == 0 and self.Rhs(Righthandside_of_Rhs) == 0):
                    return 0
                else:
                    print("Rhs Error 2 with Token {}".format(j))
                    return -1
            ...
            if(TokenList[1] == Chr):
                if(self.Rhs(TokenList[2:-1]) == 0):
                    if(TokenList[-1] == EndChr):
                        #print("Rule is {}".format(TokenList))
                        return 0
                    else:
    ...
    def Grammar(self, TokenList):
        ...
        return "Program is correct as per EBNF"
